...
import './PopularCartoonsStyle.scss';
import { Col, Container, Form, Row } from 'react-bootstrap';
import http from '../../http';
import { ISerialsItem, IGenreSerials } from '../../utils/types';

export const PopularCartoonsPages = () => {
    ...
    const SetGenres = (movies: IGenreSerials[]) => {
        const AnimeSeries = movies.filter(serial => serial.genre_name === 'Мультфільми');
        setAnimeGenre(AnimeSeries);
        const tmp = movies.filter(serial => serial.genre_name === 'Пригодницькі');
        setSonenGenre(tmp);
        const loveSeries = movies.filter(serial => serial.genre_name === 'Для всієї сім’ї');
        setLoveGenre(loveSeries);
        const ComedySeries = movies.filter(serial => serial.genre_name === 'Екшн мультфільми');
        setComedyGenre(ComedySeries);
        const LifeSeries = movies.filter(serial => serial.genre_name === 'Комедійні мультфільми');
        setLifeGenre(LifeSeries);
        const DramaSeries = movies.filter(serial => serial.genre_name === 'Детективні мультфільми');
    ...
    return (
        <Container>
            <Form.Label className="popular-text">Популярні мультфільми</Form.Label>
            <Row className='popular-films'>
                ...
                <div className="row-films">
                    <Row>
                        <Form.Label className="name-text">Найкращі пригодницькі мультфільми</Form.Label>
                    </Row>
                    <Row className="row-film">
                ...
                <div className="row-films">
                    <Row>
                        <Form.Label className="name-text">Мультфільми для всієї сім’ї</Form.Label>
                    </Row>
                    <Row className="row-film">
                ...
                <div className="row-films">
                    <Row>
                        <Form.Label className="name-text">Кращі екшн мультфільми</Form.Label>
                    </Row>
                    <Row className="row-film">
                ...
                <div className="row-films">
                    <Row>
                        <Form.Label className="name-text">Найсмішніші комедійні мультфільми</Form.Label>
                    </Row>
                    <Row className="row-film">
                    ...
                    <div className="row-films">
                        <Row>
                            <Form.Label className="name-text">Найращі детективні мультфільми</Form.Label>
                        </Row>
                        <Row className="row-film">
