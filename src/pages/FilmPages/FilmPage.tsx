            ...
            <div className="movie-description">
                ...
                <div className="description-movie">
                    <div className="container-img">
                        <img className='img-fone' src={imgFilmPage}></img>
                    </div>
                    <Form.Label className='name-film'>Мавка. Лісова пісня</Form.Label>
                    <Button className='btn-start-film'>
                        <Form.Label className='text-start-film'>Дивитись онлайн</Form.Label>
